!(function (e, t) {
    ...
    var z = function (e, t, n) {
        ...
        t = {
            weekdays: {
                shorthand: ["Вс", "Пон", "Вт", "Ср", "Чт", "Пн", "Сб"],
                longhand: [
                    "Воскресенье",
                    "Понедельник",
                    "Вторник",
    ...
    function ne(e) {
        var t = te("div", "numInputWrapper"),
            n = te("input", "numInput " + e),
            a = te("span", "arrowUp"),
            i = te("span", "arrowDown");
        return (
            (n.type = "text"),
    ...
    var ae,
        ...
        ie = {
            ...
            K: function (e, t, n) {
                e.setHours(
                    (e.getHours() % 12) +
                        12 * Z(new RegExp(n.amPM[1], "i").test(t))
                );
            },
            M: function (e, t, n) {
        ...
        re = {
            ...
            D: function (e, t, n) {
                return t.weekdays.shorthand[re.w(e, t, n)];
            },
            F: function (e, t, n) {
                return z(re.n(e, t, n) - 1, !1, t);
            },
            G: function (e, t, n) {
                return V(re.h(e, t, n));
            },
    ...
    function r(l, c) {
        ...
        function s(e) {
            if (h.config.noCalendar && 0 === h.selectedDates.length) {
                var t = h.config.minDate;
                h.setDate(
                    new Date().setHours(
                        t ? t.getHours() : h.config.defaultHour,
                        t ? t.getMinutes() : h.config.defaultMinute,
                        t && h.config.enableSeconds
                            ? t.getSeconds()
            ...
            !(function (e) {
                ...
                void 0 !== h.amPM &&
                    e.target === h.amPM &&
                    (h.amPM.textContent =
                        h.l10n.amPM[Z(h.amPM.textContent === h.l10n.amPM[0])]);
                var a = Number(n.min),
                    i = Number(n.max),
                    o = Number(n.step),
                ...
                if (void 0 !== n.value && 2 === n.value.length) {
                    var d = n === h.hourElement,
                        s = n === h.minuteElement;
                    c < a
                        ? ((c = i + c + Z(!d) + (Z(d) && Z(!h.amPM))),
                          s && D(void 0, -1, h.hourElement))
                        : i < c &&
                          ((c = n === h.hourElement ? c - i - Z(!h.amPM) : a),
                          s && D(void 0, 1, h.hourElement)),
                        h.amPM &&
                            d &&
                            ...
                            (h.amPM.textContent =
                                h.l10n.amPM[
                                    Z(h.amPM.textContent === h.l10n.amPM[0])
                                ]),
                        (n.value = V(c));
                }
            })(e),
        ...
        function u() {
            if (void 0 !== h.hourElement && void 0 !== h.minuteElement) {
                ...
                void 0 !== h.amPM &&
                    ...
                    (n = (e % 12) + 12 * Z(t === h.l10n.amPM[1]))),
                    h.config.minDate &&
                        h.minDateHasTime &&
                        h.latestSelectedDateObj &&
                        0 === q(h.latestSelectedDateObj, h.config.minDate) &&
                        (n = Math.max(n, h.config.minDate.getHours())) ===
                            h.config.minDate.getHours() &&
                        (a = Math.max(a, h.config.minDate.getMinutes())),
                    h.config.maxDate &&
                        h.maxDateHasTime &&
                        h.latestSelectedDateObj &&
                        0 === q(h.latestSelectedDateObj, h.config.maxDate) &&
                        (n = Math.min(n, h.config.maxDate.getHours())) ===
                            h.config.maxDate.getHours() &&
                        (a = Math.min(a, h.config.maxDate.getMinutes())),
                    o(n, a, i);
            }
        }
        function f(e) {
        ...
        function o(e, t, n) {
            void 0 !== h.latestSelectedDateObj &&
                ...
                h.hourElement &&
                    h.minuteElement &&
                    !h.isMobile &&
                    ((h.hourElement.value = V(
                        h.config.time_24hr
                            ? e
                            : ((12 + e) % 12) + 12 * Z(e % 12 == 0)
                    )),
                    (h.minuteElement.value = V(t)),
                    void 0 !== h.amPM &&
                        (h.amPM.textContent = h.l10n.amPM[Z(12 <= e)]),
                    void 0 !== h.secondElement &&
                        (h.secondElement.value = V(n)));
        }
        function t(e) {
            var t = parseInt(e.target.value) + (e.delta || 0);
            (4 !== t.toString().length && "Enter" !== e.key) ||
                (h.currentYearElement.blur(),
                /[^\d]/.test(t.toString()) || k(t));
        }
        function i(t, n, a) {
            return n instanceof Array
                ...
                : (t.addEventListener(n, a),
                  void h._handlers.push({ element: t, event: n, handler: a }));
        }
        function n(t) {
            return function (e) {
                1 === e.which && t(e);
        ...
        function m(e) {
            if (h.daysContainer && 1 < h.daysContainer.childNodes.length)
                switch (e.animationName) {
                    case "fpSlideLeft":
                        h.daysContainer.lastChild &&
                            h.daysContainer.lastChild.classList.remove(
                                "slideLeftNew"
                            ),
                            h.daysContainer.removeChild(
                                h.daysContainer.firstChild
                            ),
                    ...
                    case "fpSlideRight":
                        h.daysContainer.firstChild &&
                            h.daysContainer.firstChild.classList.remove(
                                "slideRightNew"
                            ),
                            h.daysContainer.removeChild(
                                h.daysContainer.lastChild
        ...
        function g(e) {
            switch (e.animationName) {
                ...
                case "fpSlideRightNew":
                    h.navigationCurrentMonth.classList.remove("slideLeftNew"),
                        h.navigationCurrentMonth.classList.remove(
                            "slideRightNew"
                        );
                    for (
                        var t = h.navigationCurrentMonth;
                        t.nextSibling && /curr/.test(t.nextSibling.className);

                    )
                        h.monthNav.removeChild(t.nextSibling);
                    for (
                        ;
                        t.previousSibling &&
                        ...
                        h.monthNav.removeChild(t.previousSibling);
        ...
        function v(e) {
            ~e.target.className.indexOf("arrow") &&
                D(e, e.target.classList.contains("arrowUp") ? 1 : -1);
        }
        function D(e, t, n) {
            var a = e && e.target,
        ...
        function C(e, t, n, a) {
            var i,
                o = S(t, !0),
                r = te("span", "flatpickr-day " + e, t.getDate().toString());
            return (
                (r.dateObj = t),
                (r.$i = a),
                r.setAttribute(
                      ...
                      W(t) &&
                          ...
                          "range" === h.config.mode &&
                              (ee(
                                  ...
                                  "startRange",
                                  h.selectedDates[0] &&
                                      0 === q(t, h.selectedDates[0])
                              ),
                              ee(
                                  r,
                                  "endRange",
                                  h.selectedDates[1] &&
                                      0 === q(t, h.selectedDates[1])
                              ))))
                ...
                "range" === h.config.mode &&
                    ...
                    !(
                        ...
                        0 <= q(i, h.selectedDates[0]) &&
                        q(i, h.selectedDates[1]) <= 0 &&
                        !W(t) &&
                        r.classList.add("inRange"),
                    1 === h.selectedDates.length &&
                        void 0 !== h.minRangeDate &&
                        void 0 !== h.maxRangeDate &&
                        (t < h.minRangeDate || t > h.maxRangeDate) &&
                ...
                a =
                    void 0 !== e
                        ...
                        : h.selectedDateElem ||
                          ...
                          h.days.childNodes[0],
                i = function () {
                    (a = a || h.days.childNodes[n]).focus(),
                        "range" === h.config.mode && I(a);
                };
            if (void 0 === a && 0 !== t)
                return (
                    0 < t
                        ? (h.changeMonth(1, !0, void 0, !0), (n %= 42))
                        : t < 0 &&
                          (h.changeMonth(-1, !0, void 0, !0), (n += 42)),
                    M(i)
                );
        ...
        function b(e) {
            if (void 0 !== h.daysContainer) {
                var t =
                        (new Date(h.currentYear, h.currentMonth, 1).getDay() -
                            h.l10n.firstDayOfWeek +
                            7) %
                        7,
                    n = "range" === h.config.mode,
                    a = h.utils.getDaysInMonth((h.currentMonth - 1 + 12) % 12),
                ...
                for (
                    h.weekNumbers &&
                        h.weekNumbers.firstChild &&
                        (h.weekNumbers.textContent = ""),
                        n &&
                            ((h.minRangeDate = new Date(
                                h.currentYear,
                                h.currentMonth - 1,
                                r
                            )),
                            (h.maxRangeDate = new Date(
                                h.currentYear,
                                h.currentMonth + 1,
                                (42 - t) % i
                            )));
                    ...
                    o.appendChild(
                        C(
                            "prevMonthDay",
                            new Date(h.currentYear, h.currentMonth - 1, r),
                            r,
                            l
                        )
                    );
                for (r = 1; r <= i; r++, l++)
                    o.appendChild(
                        C("", new Date(h.currentYear, h.currentMonth, r), r, l)
                    );
                for (var c = i + 1; c <= 42 - t; c++, l++)
                    o.appendChild(
                        C(
                            "nextMonthDay",
                            new Date(h.currentYear, h.currentMonth + 1, c % i),
                            c,
                            l
                        )
                    );
                n && 1 === h.selectedDates.length && o.childNodes[0]
                    ? ((h._hidePrevMonthArrow =
                          h._hidePrevMonthArrow ||
                          (!!h.minRangeDate &&
                              h.minRangeDate > o.childNodes[0].dateObj)),
                    ...
                    : B();
                var d = te("div", "dayContainer");
                if ((d.appendChild(o), h.config.animate && void 0 !== e))
                    for (; 1 < h.daysContainer.childNodes.length; )
                        h.daysContainer.removeChild(h.daysContainer.firstChild);
                else
                    !(function (e) {
                        for (; e.firstChild; ) e.removeChild(e.firstChild);
                    })(h.daysContainer);
                e && 0 <= e
                    ? h.daysContainer.appendChild(d)
                    : h.daysContainer.insertBefore(
                          d,
                          h.daysContainer.firstChild
                      ),
                    (h.days = h.daysContainer.childNodes[0]);
            }
        }
        function y() {
            h.weekdayContainer ||
                (h.weekdayContainer = te("div", "flatpickr-weekdays"));
        ...
        function x(e, t, n, a) {
            void 0 === t && (t = !0),
                void 0 === n && (n = h.config.animate),
                void 0 === a && (a = !1);
            var i = t ? e : e - h.currentMonth;
            if (
                !(
                    (i < 0 && h._hidePrevMonthArrow) ||
                    (0 < i && h._hideNextMonthArrow)
                )
            ) {
                if (
                    ((h.currentMonth += i),
                    ...
                    return H("onMonthChange"), B();
                var o = h.navigationCurrentMonth;
                if (i < 0)
                    for (
                        ;
                        ...
                        h.monthNav.removeChild(o.nextSibling);
                else if (0 < i)
                    for (
                        ;
                        o.previousSibling &&
                        ...
                        h.monthNav.removeChild(o.previousSibling);
                (h.oldCurMonth = h.navigationCurrentMonth),
                    (h.navigationCurrentMonth = h.monthNav.insertBefore(
                        h.oldCurMonth.cloneNode(!0),
                        0 < i ? h.oldCurMonth.nextSibling : h.oldCurMonth
                    ));
                var r = h.daysContainer;
                if (
                    (r.firstChild &&
                        r.lastChild &&
                        (0 < i
                            ? (r.firstChild.classList.add("slideLeft"),
                              ...
                              h.oldCurMonth.classList.add("slideLeft"),
                              h.navigationCurrentMonth.classList.add(
                                  "slideLeftNew"
                              ))
                            : i < 0 &&
                              (r.firstChild.classList.add("slideRightNew"),
                              r.lastChild.classList.add("slideRight"),
                              h.oldCurMonth.classList.add("slideRight"),
                              h.navigationCurrentMonth.classList.add(
                                  "slideRightNew"
                              ))),
                    (h.currentMonthElement =
                        h.navigationCurrentMonth.firstChild),
                    (h.currentYearElement =
                        h.navigationCurrentMonth.lastChild.childNodes[0]),
                    B(),
                    h.oldCurMonth.firstChild &&
                        (h.oldCurMonth.firstChild.textContent = z(
                            h.currentMonth - i,
                            h.config.shorthandCurrentMonth,
                            h.l10n
                        )),
                    M(function () {
                        return H("onMonthChange");
                    }),
            ...
            if (h.isOpen && !h.config.inline) {
                var t = E(e.target),
                    n =
                        e.target === h.input ||
                        e.target === h.altInput ||
                        h.element.contains(e.target) ||
                        (e.path &&
                            e.path.indexOf &&
                            (~e.path.indexOf(h.input) ||
                                ~e.path.indexOf(h.altInput)));
                ("blur" === e.type
                    ? n && e.relatedTarget && !E(e.relatedTarget)
                    : !n && !t) &&
                    -1 === h.config.ignoredFocusElements.indexOf(e.target) &&
                    (h.close(),
                    "range" === h.config.mode &&
                        1 === h.selectedDates.length &&
                        (h.clear(!1), h.redraw()));
        ...
        function k(e) {
            if (
                !(
                    !e ||
                    (h.currentYearElement.min &&
                        e < parseInt(h.currentYearElement.min)) ||
                    (h.currentYearElement.max &&
                        e > parseInt(h.currentYearElement.max))
                )
            ) {
                var t = e,
                    n = h.currentYear !== t;
        ...
        function S(e, t) {
            ...
            for (
                var a = 0 < h.config.enable.length,
        ...
        function T(e) {
            var t = e.target === h._input,
                n = E(e.target),
                a = h.config.allowInput,
                i = h.isOpen && (!a || !t),
                o = h.config.inline && t && !a;
            if ("Enter" === e.key && t) {
                if (a)
                    return (
                        h.setDate(
                ...
                switch (e.key) {
                    ...
                    case "ArrowDown":
                        ...
                        h.daysContainer && void 0 !== e.target.$i
                            ? e.ctrlKey
                                ? (k(h.currentYear - c), w(e.target.$i, 0))
                                : r || w(e.target.$i, 7 * c)
                            : h.config.enableTime &&
                        ...
                        break;
                    case "Tab":
                        e.target === h.hourElement
                            ? (e.preventDefault(), h.minuteElement.select())
                            : e.target === h.minuteElement &&
                              (h.secondElement || h.amPM)
                            ? (e.preventDefault(),
                              void 0 !== h.secondElement
                                  ? h.secondElement.focus()
                                  : void 0 !== h.amPM && h.amPM.focus())
                            : e.target === h.secondElement &&
                              h.amPM &&
                              (e.preventDefault(), h.amPM.focus());
                        break;
                    case h.l10n.amPM[0].charAt(0):
                        void 0 !== h.amPM &&
                            e.target === h.amPM &&
                            ((h.amPM.textContent = h.l10n.amPM[0]), u(), K());
                        break;
                    case h.l10n.amPM[1].charAt(0):
                        void 0 !== h.amPM &&
                            e.target === h.amPM &&
                            ((h.amPM.textContent = h.l10n.amPM[1]), u(), K());
                }
                H("onKeyDown", e);
            }
        }
        function I(l) {
            if (
                1 === h.selectedDates.length &&
                l.classList.contains("flatpickr-day") &&
                void 0 !== h.minRangeDate &&
                void 0 !== h.maxRangeDate
            ) {
                for (
                    var c = l.dateObj,
                        d = h.parseDate(h.selectedDates[0], void 0, !0),
                        s = Math.min(c.getTime(), h.selectedDates[0].getTime()),
                        u = Math.max(c.getTime(), h.selectedDates[0].getTime()),
                        f = !1,
                        e = s;
                    e < u;
                    e += G.DAY
                ...
                for (
                    var t = function (e, t) {
                            var n = t.getTime(),
                                a =
                                    n < h.minRangeDate.getTime() ||
                                    n > h.maxRangeDate.getTime(),
                                i = h.days.childNodes[e];
                            if (a)
                                return (
                            ...
                            var o = Math.max(h.minRangeDate.getTime(), s),
                                r = Math.min(h.maxRangeDate.getTime(), u);
                            l.classList.add(
                                c < h.selectedDates[0]
                                    ? "startRange"
                                    : "endRange"
                                ...
                                o <= n && n <= r && i.classList.add("inRange");
                        },
                        n = 0,
                        a = h.days.childNodes[n].dateObj;
                    n < 42;
                    n++,
                        a = h.days.childNodes[n] && h.days.childNodes[n].dateObj
                )
                    t(n, a);
            }
        }
        function Y() {
            !h.isOpen || h.config.static || h.config.inline || O();
        }
        function _(a) {
            return function (e) {
                var t = (h.config["_" + a + "Date"] = h.parseDate(e)),
                ...
                void 0 !== t &&
                    ...
                    h.selectedDates &&
                        ...
                        h.selectedDates.length || "min" !== a || f(t),
                        K()),
                    h.daysContainer &&
                        (P(),
                        void 0 !== t
                            ? (h.currentYearElement[a] = t
                                  .getFullYear()
                                  .toString())
        ...
        function O(e) {
            if (
                ...
                var t = h.calendarContainer.offsetHeight,
                    ...
                    r = "above" === a || ("below" !== a && o < t && i.top > t),
                    l =
                        window.pageYOffset +
                        i.top +
                        (r ? -t - 2 : e.offsetHeight + 2);
                if (
                    (ee(h.calendarContainer, "arrowTop", !r),
                    ee(h.calendarContainer, "arrowBottom", r),
                    !h.config.inline)
                ) {
                    var c = window.pageXOffset + i.left,
                        d = window.document.body.offsetWidth - i.right,
                        s = c + n > window.document.body.offsetWidth;
                    ee(h.calendarContainer, "rightMost", s),
                        h.config.static ||
                            ((h.calendarContainer.style.top = l + "px"),
                            s
                                ? ((h.calendarContainer.style.left = "auto"),
                                  (h.calendarContainer.style.right = d + "px"))
                                : ((h.calendarContainer.style.left = c + "px"),
                                  (h.calendarContainer.style.right = "auto")));
                }
            }
        }
        function P() {
            h.config.noCalendar || h.isMobile || (y(), B(), b());
        }
        function F(e) {
            ...
            if (void 0 !== t) {
                ...
                if (((h.selectedDateElem = n), "single" === h.config.mode))
                    ...
                    "range" === h.config.mode &&
                        (2 === h.selectedDates.length && h.clear(),
                        h.selectedDates.push(a),
                        0 !== q(a, h.selectedDates[0], !0) &&
        ...
        function A(e, t, n) {
            if (0 === e || e) {
                ...
                if (e instanceof Date) a = new Date(e.getTime());
                    ...
                    var o = t || (h.config || ae.defaultConfig).dateFormat,
                        r = String(e).trim();
                    if ("today" === r) (a = new Date()), (n = !0);
                    else if (/Z$/.test(r) || /GMT$/.test(r)) a = new Date(e);
                    else if (h.config && h.config.parseDate)
                        a = h.config.parseDate(e, o);
                    else {
                        a =
                            h.config && h.config.noCalendar
                ...
                h.config.errorHandler(new Error("Invalid date provided: " + i));
            }
        }
        function H(e, t) {
            var n = h.config[e];
            ...
            "onChange" === e &&
                (h.input.dispatchEvent(R("change")),
                h.input.dispatchEvent(R("input")));
        }
        function R(e) {
        ...
        function W(e) {
            for (var t = 0; t < h.selectedDates.length; t++)
                if (0 === q(h.selectedDates[t], e)) return "" + t;
            return !1;
        }
        function B() {
            h.config.noCalendar ||
                h.isMobile ||
                !h.monthNav ||
                ((h.currentMonthElement.textContent =
                    z(h.currentMonth, h.config.shorthandCurrentMonth, h.l10n) +
                    " "),
                (h.currentYearElement.value = h.currentYear.toString()),
                (h._hidePrevMonthArrow =
        ...
        function K(e) {
            if ((void 0 === e && (e = !0), !h.selectedDates.length))
                return h.clear(e);
            ...
            (h.input.value = h.selectedDates
                .map(function (e) {
                    return h.formatDate(e, h.config.dateFormat);
                })
                .join(t)),
                void 0 !== h.altInput &&
                    (h.altInput.value = h.selectedDates
                        .map(function (e) {
        ...
        function U(e) {
            ...
            var t,
                n =
                    h.currentYearElement.parentNode &&
                    h.currentYearElement.parentNode.contains(e.target);
            if (e.target === h.currentMonthElement || n) {
                var a = 0 <= ((t = e).wheelDelta || -t.deltaY) ? 1 : -1;
                n
                    ? (k(h.currentYear + a),
                      (e.target.value = h.currentYear.toString()))
                    : h.changeMonth(a, !0, !1);
            }
        }
        function $(e) {
            ...
            t || n
                ...
                ? (e.preventDefault(), h.currentYearElement.select())
        ...
        return (
            (h.parseDate = A),
            (h.formatDate = function (a, e) {
                return void 0 !== h.config && void 0 !== h.config.formatDate
                    ? h.config.formatDate(a, e)
                    : e
                          .split("")
                          .map(function (e, t, n) {
                              return re[e] && "\\" !== n[t - 1]
                                  ? re[e](a, h.l10n, h.config)
                                  : "\\" !== e
                                  ? e
                                  : "";
                          })
                ...
                (h._handlers = []),
                    h.mobileInput
                        ? (h.mobileInput.parentNode &&
                              h.mobileInput.parentNode.removeChild(
                                  h.mobileInput
                              ),
                          (h.mobileInput = void 0))
                        : h.calendarContainer &&
                          h.calendarContainer.parentNode &&
            ...
            (function () {
                ...
                h.config = J({}, ae.defaultConfig);
                var n = J({}, c, JSON.parse(JSON.stringify(l.dataset || {}))),
                    a = {};
                ...
                for (var i = 0; i < e.length; i++)
                    h.config[e[i]] =
                        !0 === h.config[e[i]] || "true" === h.config[e[i]];
                for (var i = t.length; i--; )
                    void 0 !== h.config[t[i]] &&
                        (h.config[t[i]] = X(h.config[t[i]] || []).map(d));
                for (var i = 0; i < h.config.plugins.length; i++) {
                    var o = h.config.plugins[i](h) || {};
                    for (var r in o)
                        ~t.indexOf(r)
                            ? (h.config[r] = X(o[r]).map(d).concat(h.config[r]))
                            : void 0 === n[r] && (h.config[r] = o[r]);
                }
                (h.isMobile =
            ...
            "object" != typeof h.config.locale &&
                void 0 === ae.l10ns[h.config.locale] &&
                h.config.errorHandler(
            ...
            (function () {
                ...
                e && L(e, h.config.dateFormat);
                var t = h.selectedDates.length
                    ? h.selectedDates[0]
                    : h.config.minDate &&
                ...
                (h.currentYear = t.getFullYear()),
                    ...
                    Object.defineProperty(h, "showTimeInput", {
                        ...
                        set: function (e) {
                            (h._showTimeInput = e),
                                h.calendarContainer &&
                                    ee(h.calendarContainer, "showTimeInput", e),
                                O();
                        },
                    });
            })(),
            ...
            h.isMobile ||
                (function () {
                    ...
                    if (
                        ...
                        if (
                            (e.appendChild(
                                (function () {
                                    ...
                                    (h.monthNav = te("div", "flatpickr-month")),
                                        (h.prevMonthNav = te(
                                            "span",
                                        ...
                                        (h.prevMonthNav.innerHTML =
                                            h.config.prevArrow),
                                        (h.currentMonthElement = te(
                                            "span",
                                            "cur-month"
                                        )),
                                        (h.currentMonthElement.title =
                                            h.l10n.scrollTitle);
                                    var t = ne("cur-year");
                                    return (
                                        (h.currentYearElement =
                                            t.childNodes[0]),
                                        (h.currentYearElement.title =
                                            h.l10n.scrollTitle),
                                        h.config.minDate &&
                                            (h.currentYearElement.min =
                                                h.config.minDate
                                        ...
                                        (h.nextMonthNav.innerHTML =
                                            h.config.nextArrow),
                                        (h.navigationCurrentMonth = te(
                                            "div",
                                            "flatpickr-current-month"
                                        )),
                                        h.navigationCurrentMonth.appendChild(
                                            h.currentMonthElement
                                        ),
                                        h.navigationCurrentMonth.appendChild(t),
                                        e.appendChild(h.prevMonthNav),
                                        e.appendChild(h.navigationCurrentMonth),
                                        e.appendChild(h.nextMonthNav),
                                        h.monthNav.appendChild(e),
                            ...
                            var t = (function () {
                                    ...
                                    var e = te("div", "flatpickr-weekwrapper");
                                    e.appendChild(
                                        te(
                                            "span",
                                            "flatpickr-weekday",
                        ...
                        (h.rContainer = te("div", "flatpickr-rContainer")),
                            h.rContainer.appendChild(y()),
                            h.daysContainer ||
                                ((h.daysContainer = te(
                                    "div",
                                    "flatpickr-days"
                    ...
                    h.config.enableTime &&
                        e.appendChild(
                            (function () {
                                ...
                                var n = ne("flatpickr-minute");
                                if (
                                    ((h.minuteElement = n.childNodes[0]),
                                    ...
                                    (h.minuteElement.step =
                                        h.config.minuteIncrement.toString()),
                                    (h.hourElement.min = h.config.time_24hr
                                        ? "0"
                                        : "1"),
                                    (h.hourElement.max = h.config.time_24hr
                                        ? "23"
                                        : "12"),
                                    (h.minuteElement.min = "0"),
                                    (h.minuteElement.max = "59"),
                                    (h.hourElement.title =
                                        h.minuteElement.title =
                                            h.l10n.scrollTitle),
                                    ...
                                    var a = ne("flatpickr-second");
                                    (h.secondElement = a.childNodes[0]),
                                        (h.secondElement.value = V(
                                            h.latestSelectedDateObj
                                                ? h.latestSelectedDateObj.getSeconds()
                                                : h.config.defaultSeconds
                                        )),
                                        (h.secondElement.step =
                                            h.minuteElement.step),
                                        (h.secondElement.min =
                                            h.minuteElement.min),
                                        (h.secondElement.max =
                        ...
                        ee(h.calendarContainer, "animate", h.config.animate),
                        h.calendarContainer.appendChild(e);
                    var i =
                        void 0 !== h.config.appendTo &&
                        h.config.appendTo.nodeType;
                    if (
                        ...
                        var o = te("div", "flatpickr-wrapper");
            ...
            (function () {
                if (
                    ...
                    return (function () {
                        ...
                        i(h.mobileInput, "change", function (e) {
                ...
                var e = Q(Y, 50);
                (h._debouncedChange = Q(a, 300)),
                    "range" === h.config.mode &&
                        h.daysContainer &&
                        !/iPhone|iPad|iPod/i.test(navigator.userAgent) &&
                        i(h.daysContainer, "mouseover", function (e) {
                            return I(e.target);
                        }),
                    i(window.document.body, "keydown", T),
                    h.config.static || i(h._input, "keydown", T),
                    h.config.inline ||
                        h.config.static ||
                        i(window, "resize", e),
                    void 0 !== window.ontouchstart &&
                        i(window.document.body, "touchstart", N),
                    i(window.document.body, "mousedown", n(N)),
                    i(h._input, "blur", N),
                    !0 === h.config.clickOpens &&
                        (i(h._input, "focus", h.open),
                        i(h._input, "mousedown", n(h.open))),
                    void 0 !== h.daysContainer &&
                        (h.monthNav.addEventListener("wheel", function (e) {
                            return e.preventDefault();
                        }),
                        i(h.monthNav, "wheel", Q(U, 10)),
                        i(h.monthNav, "mousedown", n($)),
                        i(h.monthNav, ["keyup", "increment"], t),
                        i(h.daysContainer, "mousedown", n(F)),
                        h.config.animate &&
                            (i(
                                h.daysContainer,
                    ...
                    void 0 !== h.timeContainer &&
                        ...
                        void 0 !== h.hourElement &&
                        (i(h.timeContainer, ["wheel", "input", "increment"], s),
                        i(h.timeContainer, "mousedown", n(v)),
                        i(
                            h.timeContainer,
                            ["wheel", "increment"],
                            h._debouncedChange
                        ),
                        i(h.timeContainer, "input", a),
                        i(
                        ...
                        void 0 !== h.secondElement &&
                            i(h.secondElement, "focus", function () {
                                return (
                                    h.secondElement && h.secondElement.select()
                                );
                            }),
                        void 0 !== h.amPM &&
                            i(
    ...
    return (
        ...
        "object" == typeof window && (window.flatpickr = ae),
        (ae.defaultConfig = e),
        (ae.l10ns = { en: J({}, t), default: J({}, t) }),
        (ae.localize = function (e) {
            ae.l10ns.default = J({}, ae.l10ns.default, e);
        }),
        (ae.setDefaults = function (e) {
            ae.defaultConfig = J({}, ae.defaultConfig, e);
        }),
