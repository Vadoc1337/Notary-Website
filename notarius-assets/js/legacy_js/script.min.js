    ...
    $.fn.megaMenu = function (options) {
        var menu = $(this),
            ...
            isTouchDevice =
                ...
                window.innerWidth <= triggerTablet,
            isMobile;
        ...
        var mobileOff = function () {
            ...
            menu.removeClass(mobileOnClass)
                .siblings(mobileTriggerClass)
        ...
        var getMenuWidth = function (string_width) {
            ...
            if (0 <= string_width.indexOf("%")) {
                width =
                    ($(menu.settings.parent).width() * parseInt(string_width)) /
                    100;
            }
            ...
            $("li" + parentMegaClass, menu).each(function () {
                ...
                if ("fullwidth" != position) {
                    if (windowWidth >= triggerFullscreen) {
                        ...
                        windowWidth >= triggerDesktop &&
                        windowWidth < triggerFullscreen
                    ) {
                ...
                anchor.siblings(subClass).css(styles);
            });
        };
        ...
        var showPanel = function (anchor) {
            ...
            anchor.parent().siblings().removeClass(inTransitionClass);
        };
