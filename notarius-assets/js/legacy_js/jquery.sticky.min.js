    ...
    var Sticky = function (element, userSettings) {
        ...
        var backupCSS = function ($element, backupState, properties) {
            ...
            properties.forEach(function (property) {
                css[property] =
                    undefined !== elementStyle[property]
        ...
        var unfollowParent = function () {
            elements.$parent.css(
                getCSSBackup(elements.$parent, "childNotFollowing")
            );
        ...
        var getElementOuterSize = function (
            ...
            propertiesToAdd.forEach(function (property) {
                sides.forEach(function (side) {
                    elementSize += parseFloat(
                        computedStyle[property + "-" + side]
                    );
                });
            });
            return elementSize;
            ...
            if (isFollowingParent) {
                ...
                var parentOffset = getElementViewportOffset(elements.$parent),
                    ...
                    borderWidthToDecrease = parseFloat(
                        parentStyle[
                            isTop ? "borderBottomWidth" : "borderTopWidth"
                        ]
                    ),
                    ...
                    isNeedFollowing = isTop
                        ...
                        : parentViewportDistance >=
                          elementOffset.top.fromBottom;
                if (isNeedFollowing) {
                    followParent();
                }
            }
        ...
        var checkPosition = function () {
            ...
            if (isSticky) {
                var spacerViewportOffset = getElementViewportOffset(
                    elements.$spacer
                );
                distanceFromTriggerPoint =
                    "top" === settings.to
