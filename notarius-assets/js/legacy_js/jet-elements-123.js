(function ($, elementor) {
    ...
    var JetElements = {
        init: function () {
            var widgets = {
                ...
                "jet-image-comparison.default":
                    JetElements.widgetImageComparison,
                "jet-instagram-gallery.default":
                    JetElements.widgetInstagramGallery,
                "jet-scroll-navigation.default":
                    JetElements.widgetScrollNavigation,
        ...
        widgetCountdown: function ($scope) {
            ...
            JetElements.widgetCountdown.updateClock = function () {
                var timeRemaining =
                    JetElements.widgetCountdown.getTimeRemaining(endTime);
        ...
        widgetMap: function ($scope) {
            ...
            if (pins) {
                $.each(pins, function (index, pin) {
                    var marker,
                        infowindow,
                        pinData = { position: pin.position, map: map };
                    if ("" !== pin.image) {
                    ...
                    marker.addListener("click", function () {
                        infowindow.setOptions({ disableAutoPan: !1 });
        ...
        widgetProgress: function ($scope) {
            ...
            var $value = $progress.find(".circle-progress__value"),
                ...
                duration = $scope
                    .find(".circle-progress-wrap")
                    .data("duration");
            $value.css({ "transitionDuration": duration + "ms" });
            elementorFrontend.waypoint(
                ...
                function () {
                    ...
                    $value.css({ "strokeDashoffset": dashoffset });
                },
        ...
        widgetSubscribeForm: function ($scope) {
            ...
            jetSubscribeFormAjax = new CherryJsCore.CherryAjaxHandler({
                ...
                successCallback: function (data) {
                    var successType = data.type,
                        ...
                        responceClass =
                            "jet-subscribe-form--response-" + successType;
            ...
            function subscribeHandle() {
                var inputValue = $mailField.val(),
                    sendData = {
                        "email": inputValue,
                        "use_target_list_id": settings.use_target_list_id || !1,
        ...
        widgetSlider: function ($scope) {
            ...
            $target
                ...
                .progress(function (instance, image) {
                    ...
                    if (image.isLoaded) {
                        ...
                        progressBarWidth =
                            100 *
                                (loadedImages.length / $imagesTagList.length) +
                            "%";
                        $(".jet-slider-loader", $target).css({
            ...
            var tabletHeight =
                "" !== settings.sliderHeightTablet.size
                    ? settings.sliderHeightTablet.size +
                      settings.sliderHeightTablet.unit
                    : settings.sliderHeight.size + settings.sliderHeight.unit;
            var mobileHeight =
                "" !== settings.sliderHeightMobile.size
                    ? settings.sliderHeightMobile.size +
                      settings.sliderHeightMobile.unit
                    : settings.sliderHeight.size + settings.sliderHeight.unit;
            $(".slider-pro", $target).sliderPro({
                ...
                slideDistance:
                    "string" !== typeof settings.slideDistance.size
                        ? settings.slideDistance.size
                        : 0,
                ...
                init: function () {
                    this.resize();
                    $(".sp-previous-arrow", $target).append(
                        '<i class="' + settings.sliderNavigationIcon + '"></i>'
                    );
                    $(".sp-next-arrow", $target).append(
                        '<i class="' + settings.sliderNavigationIcon + '"></i>'
                    );
                    $(".sp-full-screen-button", $target).append(
                        '<i class="' + settings.sliderFullscreenIcon + '"></i>'
                    );
                },
                breakpoints: {
                    1023: { height: tabletHeight },
                    767: { height: mobileHeight },
                },
            });
        },
        ...
        widgetImageComparison: function ($scope) {
            var $target = $scope.find(".jet-image-comparison__instance"),
                ...
                imageComparisonItems = $(
                    ".jet-image-comparison__container",
                    $target
                ),
                settings = $target.data("settings"),
            ...
            settings.draggable = !1;
            settings.infinite = !1;
            JetElements.initCarousel($target, settings);
        },
        widgetTimeTable: function ($scope) {
            var $mptt_shortcode_wrapper = $scope.find(
            ...
            if (
                $(".upcoming-events-widget").length ||
                $mptt_shortcode_wrapper.length
            ) {
        ...
        widgetVideo: function ($scope) {
            var $video = $scope.find(".jet-video"),
                ...
                mejsPlaerControls = $mejsPlaer.data("controls") || [
                    "playpause",
                    "current",
                    "progress",
                    "duration",
    ...
    window.jetAnimatedText = function ($selector, settings) {
        var self = this,
            ...
            settings = settings || {},
            currentIndex = 0;
        defaultSettings = { effect: "fx1", delay: 3000 };
        $.extend(defaultSettings, settings);
        self.avaliableEffects = {
            ...
            "fx12": {
                ...
                out: {
                    ...
                    delay: function (el, index) {
                        return (
                            (el.parentNode.children.length - index - 1) * 100
                        );
                    },
                    easing: "linear",
                    width: { value: 0 },
        ...
        self.init = function () {
            ...
            self.showText($text, settings.effect, null, function () {
                self.textChange();
            });
        };
    };
    ...
    window.jetScrollNavigation = function ($selector, settings) {
        ...
        self.init = function () {
            ...
            if (settings.sectionSwitch) {
                ...
                $document.on(
                    "mousewheel.jetScrollNavigation DOMMouseScroll.jetScrollNavigation",
                    self.onWheel
                );
            }
        ...
        self.onWheel = function (event) {
            ...
            if (sectionId && sections.hasOwnProperty(sectionId)) {
                prevSectionId = JetElementsTools.getObjectPrevKey(
                    sections,
                    sectionId
                );
                nextSectionId = JetElementsTools.getObjectNextKey(
                    sections,
                    sectionId
                );
                if ("up" === direction) {
                ...
                if (newSectionId) {
                    ...
                    $itemsList.removeClass("active");
                    $("[data-anchor=" + newSectionId + "]", $instance).addClass(
                        "active"
                    );
                    $itemsList.removeClass("invert");
        ...
        self.setSectionsData = function () {
            $itemsList.each(function () {
                var $this = $(this),
                    sectionId = $this.data("anchor"),
                    sectionInvert = "yes" === $this.data("invert") ? !0 : !1,
                    $section = $("#" + sectionId);
    ...
    window.jetSectionParallax = function ($target) {
        ...
        self.init = function () {
            if (!editMode) {
                settings = jetElements.jetParallaxSections[sectionId] || !1;
            } else {
        ...
        self.generateEditorSettings = function (sectionId) {
            ...
            if (
                !sectionData.hasOwnProperty("jet_parallax_layout_list") ||
                0 === Object.keys(sectionData).length
            ) {
                return !1;
            }
        ...
        self.generateLayouts = function () {
            ...
            $.each(settings, function (index, layout) {
                var imageData = layout.jet_parallax_layout_image,
                    ...
                    animProp =
                        layout.jet_parallax_layout_animation_prop ||
                        "bgposition",
                    bgX = layout.jet_parallax_layout_bg_x,
                    bgY = layout.jet_parallax_layout_bg_y,
                    type = layout.jet_parallax_layout_type || "none",
                    device = layout.jet_parallax_layout_on || [
                        "desktop",
                        "tablet",
                    ],
                    $layout = null,
                ...
                $layout = $(
                    '<div class="jet-parallax-section__layout jet-parallax-section__' +
                        type +
                        "-layout" +
                        macClass +
        ...
        self.scrollUpdate = function () {
            $.each(scrollLayoutList, function (index, layout) {
                var $this = layout.selector,
                    ...
                    type = layout.type,
                    posY =
                        ((winScrollTop - offsetTop + winHeight) / thisHeight) *
                        100,
                ...
                switch (type) {
                    ...
                    case "zoom":
                        var deltaScale =
                                (winScrollTop - offsetTop + winHeight) /
                                winHeight,
                ...
                switch (prop) {
                    case "bgposition":
                        TweenMax.to($image[0], 1, {
                            backgroundPositionX:
                                "calc(" + layout.xPos + "% + " + posX + "px)",
                            backgroundPositionY:
                                "calc(" + layout.yPos + "% + " + posY + "px)",
                            ease: Power2.easeOut,
                        });
                        break;
                    case "transform":
    ...
    window.jetPortfolio = function ($selector, settings) {
        ...
        self.generateData = function () {
            ...
            $itemsList.each(function (index) {
                ...
                itemsData[index] = {
                    selector: $this,
                    slug: slug,
                    visible: $this.hasClass("visible-status") ? !0 : !1,
                    more: $this.hasClass("hidden-status") ? !0 : !1,
                };
            });
        };
        self.filterHandler = function (event) {
            ...
            for (var slugName in filterData) {
                filterData[slugName] = !1;
                if (slugName == slug) {
                    filterData[slugName] = !0;
                }
            }
        ...
        self.moreButtonHandler = function (event) {
            ...
            $.each(itemsData, function (index, obj) {
                if (
                    self.isItemVisible(obj.slug) &&
                    obj.more &&
                    counter <= settings.perPage
                ) {
                    obj.more = !1;
                    obj.visible = !0;
                    counter++;
    ...
    window.jetTimeLine = function ($element) {
        ...
        self.updateWindow = function () {
            ...
            $line.css({
                "top":
                    $cards.first().find($points).offset().top -
        ...
        self.updateProgress = function () {
            var progressFinishPosition = $cards
                    .last()
                    .find($points)
                    .offset().top,
                progressHeight =
            ...
            if (
                ...
                currentScrollTop + currentViewportHeight / 2
            ) {
                progressHeight =
                    progressFinishPosition - $progress.offset().top;
            }
            $progress.css({ "height": progressHeight + "px" });
            $cards.each(function () {
                if (
                    $(this).find($points).offset().top <
                    currentScrollTop + currentViewportHeight * 0.5
                ) {
        ...
        self.animateCards = function () {
            $cards.each(function () {
                if (
                    $(this).offset().top <=
                        currentScrollTop + currentViewportHeight * 0.9 &&
